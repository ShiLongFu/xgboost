...
# tSAH: 分类选择
tSAH = st.selectbox("Severe tSAH (Morris-Marshall grade 3 or 4):", options=[0, 1], format_func=lambda x: 'No (0)' if x == 0 else 'Yes (1)')

# 处理输入并进行预测
feature_values = [Hemoglobin, Fibrinogen, SDH, Severe tSAH]
